 ...
 *
 */
public class SelectionRandomRobinBuyerMixer extends AbstractMarketMixer
	 ...
	 * 
	 */
	public SelectionRandomRobinBuyerMixer() {
	}
	
	/**
	 * @param prng
	 */
	public SelectionRandomRobinBuyerMixer(RandomEngine prng) {
		super();
		this.prng = prng;
	}
